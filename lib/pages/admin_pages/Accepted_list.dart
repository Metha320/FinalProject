...
import '../../components/admin/consult/date_appointment.dart';
...
class Accepted_list extends StatefulWidget {
  const Accepted_list({Key? key}) : super(key: key);
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(color: greentxt, width: 3)),
                  child: Row(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      color: greyBG, borderRadius: BorderRadius.circular(20)),
                  child: Align(
                    alignment: Alignment.center,
                    child: AutoSizeText(
                      'รายการที่ถูกยอมรับแล้วจะไม่สามารถปฏิเสธภายหลังได้',
                      minFontSize: 8,
                      maxLines: 1,
                      stepGranularity: 1,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.center,
                      style: TextStyle(color: greytxt, fontSize: 16),
                    ),
                  ),
                ),
