...
class register3_button extends StatefulWidget {
  const register3_button({Key? key}) : super(key: key);

  @override
  State<register3_button> createState() => _register3_buttonState();
}

class _register3_buttonState extends State<register3_button> {
              ...
              child: FloatingActionButton.extended(
                ...
                onPressed: () {
                  Navigator.of(context).push(new MaterialPageRoute(
                      builder: (BuildContext context) => register_()));
                },
              ),
            ),
          ),
